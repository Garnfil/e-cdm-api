                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control" id="basic-phone-number"
                                                ...
                                                value="{{ substr($guardian->phone_number, 3) }}" />
                                        </div>
                                    </div>
                                </div>
                                <div class="col-xl-4">
                                    <div class="mb-3">
                                        ...
                                        <select name="gender" id="gender-select-field" class="form-select">
                                            <option {{ $guardian->gender == 'Male' ? 'selected' : null }} value="Male">
                                                Male</option>
                                            <option {{ $guardian->gender == 'Female' ? 'selected' : null }} value="Female">
                                                Female</option>
                                        </select>
                                    </div>
                                </div>
                            ...
                            <div class="form-group mb-3">
                                ...
                                <select name="student_ids[]" id="students-select-field" class="form-select" multiple>
                                    ...
                                    @foreach ($students as $student)
                                        <option {{ in_array($student->id, $guardian_student_ids) ? 'selected' : null }}
                                            value="{{ $student->id }}">
