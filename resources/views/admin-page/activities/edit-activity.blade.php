    ...
    <div class="container-xxl my-4">
        <section class="section-header d-flex justify-content-between align-items-center">
            <div class="title-section">
                <h4 class="fw-medium mb-2">Edit Activity</h4>
                <h6 class="fw-medium text-primary"><a href="#" class="text-muted fw-light">Dashboard /</a> Edit
                    Activity
                </h6>
            </div>
            <div class="action-section btn-group">
                <a href="{{ route('admin.activities.index') }}" class="btn btn-primary"><i class="bx bx-undo"></i> Back to
                    List</a>
            </div>
        </section>
                ...
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route('admin.activities.update', $activity->id) }}" method="POST">
                            ...
                            <div class="row">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select name="instructor_id" id="instructor-field" class="form-select">
                                            @foreach ($instructors as $instructor)
                                                <option
                                                    {{ $instructor->id == $activity->instructor_id ? 'selected' : null }}
                                ...
                                <div class="col-xl-6">
                                    <div class="mb-3">
                                        ...
                                        <textarea name="description" id="description-field" class="form-control" cols="30" rows="5">{{ $activity->description }}</textarea>
                                    </div>
                                </div>
                                <div class="col-xl-6">
                                    <div class="mb-3">
                                        <label for="notes-field" class="form-label">Notes</label>
                                        <textarea name="notes" id="notes-field" class="form-control" cols="30" rows="5">{{ $activity->activity->notes }}</textarea>
                                    </div>
                                </div>
                                <div class="col-xl-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" name="points" id="points-field"
                                            value="{{ $activity->activity->points }}">
                                    </div>
                                </div>
                                <div class="col-xl-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="datetime-local" class="form-control" name="due_datetime"
                                            id="due-datetime-field" value="{{ $activity->due_datetime }}">
                                    </div>
                                </div>
                                <div class="col-xl-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <div class="form-check">
                                            <input name="status" class="form-check-input" type="radio" value="posted"
                                                ...
                                                {{ $activity->status == 'posted' ? 'checked' : null }} />
                                        ...
                                        <div class="form-check">
                                            <input name="status" class="form-check-input" type="radio" value="drafted"
                                                ...
                                                {{ $activity->status == 'drafted' ? 'checked' : null }} />
                            ...
                            <button class="btn btn-primary">Save Activity <i class='bx bxs-download'></i></button>
                        </form>
                    </div>
                </div>
            </div>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{ route('admin.school_works.attachments.upload') }}" enctype="multipart/form-data"
                            method="POST">
                            @csrf
                            <input type="hidden" name="school_work_id" value="{{ $activity->id }}">
                            <div class="form-group mb-3">
