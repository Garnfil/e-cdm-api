    ...
    <div class="container-xxl my-4">
        <section class="section-header d-flex justify-content-between align-items-center">
            <div class="title-section">
                <h4 class="fw-medium mb-2">Edit Exam</h4>
                            ...
                            <div class="row">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select name="instructor_id" id="instructor-field" class="form-select">
                                            @foreach ($instructors as $instructor)
                                                <option {{ $instructor->id == $exam->instructor_id ? 'selected' : null }}
                                ...
                                <div class="col-xl-12">
                                    <div class="mb-3">
                                        ...
                                        <textarea name="description" id="description-field" class="form-control" cols="30" rows="5">{{ $exam->description }}</textarea>
                                    </div>
                                </div>
                                <div class="col-xl-6">
                                    <div class="mb-3">
                                ...
                                <div class="col-xl-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="datetime-local" class="form-control" name="due_datetime"
                                            id="due-datetime-field" value="{{ $exam->due_datetime }}">
                                    </div>
                                </div>
                                <div class="col-xl-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <div class="form-check">
                                            <input name="status" class="form-check-input" type="radio" value="posted"
                                                ...
                                                {{ $exam->status == 'posted' ? 'checked' : null }} />
                                        ...
                                        <div class="form-check">
                                            <input name="status" class="form-check-input" type="radio" value="drafted"
                                                ...
                                                {{ $exam->status == 'drafted' ? 'checked' : null }} />
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{ route('admin.school_works.attachments.upload') }}" enctype="multipart/form-data"
                            method="POST">
                            @csrf
                            <input type="hidden" name="school_work_id" value="{{ $exam->id }}">
                            <div class="form-group mb-3">
                            ...
                            <div class="w-100">
                                <div class="demo-inline-spacing mt-3">
                                    <div class="list-group">
                                        @forelse ($exam->attachments as $attachment)
